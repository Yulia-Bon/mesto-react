    ...
    return (
        <div className="pages">
            ...
            <PopupWithForm title="Редактировать профиль" name="profile" onClose={closeAllPopups} isOpen={isEditProfilePopupOpen} buttonText="Сохранить">
                <input className="popup__input popup-user__input-name" id ="user-name-input" name="name" type="text" value="nik"
                ...
                <input className=" popup__input  popup-user__input popup-user__input_type_job" id="user-description-input" type="text" value="job"
            ...
            <PopupWithForm title="Новое место" name="place" isOpen={isAddPlacePopupOpen} onClose={closeAllPopups} buttonText="Создать">
                ...
                <input className="popup__input popup-photos__input popup-photos__input_type_card-src" id="card-src-input" type="url"
